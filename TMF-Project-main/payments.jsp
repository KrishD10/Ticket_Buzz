        ...
        <section class="payment-section">
            ...
            <form id="payment-form">
                <div class="form-group">
                    ...
                    <input type="text" id="card-number" required pattern="\d{16}" placeholder="6473 9238 9823 3525" aria-label="Card Number">
                </div>
                <div class="form-group">
                    <label for="cardholder-name">Cardholder Name:</label>
                    <input type="text" id="cardholder-name" required placeholder="Arnold" aria-label="Cardholder Name">
                </div>
                <div class="row">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="cvv" required pattern="\d{3}" placeholder="345" aria-label="CVV">
                    </div>
                </div>
